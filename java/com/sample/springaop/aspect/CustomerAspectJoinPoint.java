package com.sample.springaop.aspect;
...
public class CustomerAspectJoinPoint {
	...
	@Before("execution(* com.sample.springaop.service.CustomerAdvanceService.*(..)) && args(firstName, id)")
	public void logStringArguments(String firstName, long id) {
		System.out.println("Passed Arguments: [" + "firstName = " + firstName + "; id = " + id + "]");
	}

	@Before("execution(* com.sample.springaop.service.CustomerAdvanceService.setCustomerFirstName(..))")
	...
	@Around("execution(* com.sample.springaop.service.CustomerAdvanceService.findAllCustomers())")
