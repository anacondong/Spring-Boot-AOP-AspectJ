...
public class CustomerAspectPointcut {
	...
	@Pointcut("execution(* com.sample.springaop.service.CustomerAnotherService.findCustomerByLastName(..))")
	...
	@Pointcut("within(com.sample.springaop.service.CustomerAnotherService)")
